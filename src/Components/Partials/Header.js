            ...
            <Navbar bg="dark" variant="dark" expand="md" role="navigation">
                <Navbar.Brand as="a" href={`${publicUrl}/#/`}>
                    <img
                        ...
                        alt={`${title} logo`}
                    /> react-carousel-info-site</Navbar.Brand>
                <Navbar.Toggle aria-controls="site-navbar-nav" />
                <Navbar.Collapse id="site-navbar-nav">
                    <Nav className="mr-auto">
                        <Nav.Link id="home_link" href={`${publicUrl}/#/`}>Home</Nav.Link>
                        <Nav.Link id="about_link" href={`${`${publicUrl}/#/`}about`}>About Us</Nav.Link>
                        <Nav.Link id="contact_link" href={`${`${publicUrl}/#/`}contact`}>Contact Us</Nav.Link>
                    </Nav>
